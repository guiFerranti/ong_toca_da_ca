        ...
        <form action="{{ route('adocao.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-gray-50 p-4 sm:p-6 rounded-lg">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2" x-data="{ temAnimais: '{{ old('tem_animais', '') }}' }">
                        ...
                        <div class="mt-2" x-show="temAnimais === '1'" x-transition>
